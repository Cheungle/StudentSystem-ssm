                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="item d-flex align-items-center">
                                ...
                                <div class="title"><span>New<br>courses</span>
                                    <div class="progress">
                                        <div role="progressbar" style="width: 15%; height: 4px;" aria-valuenow="15"
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="item d-flex align-items-center">
                                ...
                                <div class="title"><span>Credits<br>gained</span>
                                    <div class="progress">
                                        <div role="progressbar" style="width: 77%; height: 4px;" aria-valuenow="77"
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="item d-flex align-items-center">
                                ...
                                <div class="title"><span>Second<br>Credits</span>
                                    <div class="progress">
                                        <div role="progressbar" style="width: 60%; height: 4px;" aria-valuenow="60"
                                ...
                                <div class="card-body no-padding">
                                    <div class="item d-flex align-items-center">
                                        <div class="text"><a href="#">
                                            <h3 class="h5">You have a new grade published.</h3></a><small>Posted on 5th
                                            December 2019 by Teacher Chen. </small></div>
                                    </div>
                                    <div class="item d-flex align-items-center">
                                        <div class="text"><a href="#">
                                            <h3 class="h5">You have a test date changed.</h3></a><small>Posted on 5th
                                            December 2019 by admin. </small></div>
                                    </div>
                                    <div class="item d-flex align-items-center">
                                        <div class="text"><a href="#">
                                            <h3 class="h5">School notice.</h3></a><small>Posted on 5th December 2019 by
                                            admin. </small></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="checklist card">
                                ...
                                <div class="card-body no-padding">
                                    <div class="item d-flex">
                                        ...
                                        <label for="input-1">Reciting words and practicing in order to have
                                            CET-6.</label>
                                    </div>
                                    <div class="item d-flex">
                                    ...
                                    <div class="item d-flex">
                                        ...
                                        <label for="input-3">Be ready to take part in the postgraduate entrance
                                            exams.</label>
                                    </div>
                                    <div class="item d-flex">
...
<script type="text/javascript">
    ...
    function updateData() {
        ...
        $.ajax({
            url: "student/countBeforeCreditOfOne",
            type: "post",
            async: false,
            headers: {
                'Content-Type': 'application/json'
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                for (var i = 0; i < eval(data).length; i++) $("#projects").append("<div class=\"project\"><div class=\"row bg-white has-shadow\"><div class=\"left-col col-lg-6 d-flex align-items-center justify-content-between\"><div class=\"project-title d-flex align-items-center\"><div class=\"text\"><h3 class=\"h4\">" + data[i].courseName + "</h3><small>At " + data[i].classroom + "</small></div></div><div class=\"project-date\"><span class=\"hidden-sm-down\">Today at " + data[i].startTime + "</span></div></div><div class=\"right-col col-lg-6 d-flex align-items-center\"><div class=\"time\"><i class=\"fa fa-clock-o\"></i>" + data[i].sumClasses + " </div><div class=\"time\">Now</div><div class=\"project-progress\"><div class=\"progress\"><div role=\"progressbar\" style=\"width: 75%; height: 6px;\" aria-valuenow=\"75\" aria-valuemin=\"0\" aria-valuemax=\"100\" class=\"progress-bar bg-red\"></div></div></div></div></div></div>");
            }, error: function (data) {

            }
        });
    }
    // 从JSP表达式获取Token（服务端渲染时填充）
    var token = '${token}'?'${token}':localStorage.getItem('token');
