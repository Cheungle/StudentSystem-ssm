              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item dropdown term" ><a href="#" data-toggle="dropdown" class="dropdown-collapse">Now</a>
                    <ul class="dropdown-menu list-unstyled has-shadow">
                      <li><a href="pasttest.jsp"> Past </a></li>
                  </ul>
                </li>
              </ul>
            </div>
			...
			$.ajax({
				...
				success: function(data){
					 ...
					 for(var j = 0;j<eval(data).length;j++){
						 $(".testtable").append("<tr><th scope=\"row\">"+data[j].nameCourse+"</th><td class=\"include\">"+data[j].testTime+"</td><td class=\"include\">"+data[j].testPlace+"</td></tr>");
				}}
	       });
