          ...
          <ul class="list-unstyled">
              ...
              <li class="active" ><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-grid"></i>Timetable & Grades </a>
                <ul id="exampledropdownDropdown" class="collapse.in list-unstyled ">
                  ...
                  <li class="active"><a href="test.jsp">Test Schedule</a></li>
        ...
        <div class="content-inner">
          ...
          <div class="breadcrumb-holder container-fluid">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item dropdown term" ><a href="#" data-toggle="dropdown" class="dropdown-collapse">Past</a>
                    <ul class="dropdown-menu list-unstyled has-shadow">
                      <li><a href="test.jsp"> Now </a></li>
                  </ul>
                </li>
              </ul>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                        <div class="card">
                          ...
                          <div class="card-header d-flex align-items-center">
                            <h3 class="h4">2017-2018 Second term</h3>
                          </div>
                          <div class="card-body">
                            <div class="table-responsive">
                              <table class="table table-striped">
    	 ...
    	 $(".17-18-1").empty();
			$.ajax({
				...
				success: function(data){
					 ...
					 for(var j = 0;j<eval(data).length;j++){
						 $(".17-18-1").append("<tr><th scope=\"row\">"+data[j].nameCourse+"</th><td class=\"include\">"+data[j].testTime+"</td><td class=\"include\">"+data[j].testPlace+"</td></tr>");
				}}
	       });
			$(".17-18-2").empty();
			$.ajax({
				...
				success: function(data){
					 ...
					 for(var j = 0;j<eval(data).length;j++){
						 $(".17-18-2").append("<tr><th scope=\"row\">"+data[j].nameCourse+"</th><td class=\"include\">"+data[j].testTime+"</td><td class=\"include\">"+data[j].testPlace+"</td></tr>");
				}}
	       });
			...
			$.ajax({
				...
				success: function(data){
					 ...
					 for(var j = 0;j<eval(data).length;j++){
						 $(".18-19-1").append("<tr><th scope=\"row\">"+data[j].nameCourse+"</th><td class=\"include\">"+data[j].testTime+"</td><td class=\"include\">"+data[j].testPlace+"</td></tr>");
				}}
	       });
			...
			$.ajax({
				...
				success: function(data){
					 ...
					 for(var j = 0;j<eval(data).length;j++){
						 $(".18-19-2").append("<tr><th scope=\"row\">"+data[j].nameCourse+"</th><td class=\"include\">"+data[j].testTime+"</td><td class=\"include\">"+data[j].testPlace+"</td></tr>");
				}}
	       });
